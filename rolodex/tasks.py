...
REVIEW_INSTRUCTIONS = (
    ...
    "(give the English / US version of each, and its real URL; name each file by what it is, language "
    "and country, e.g. 'Safety data sheet (EN, United States)'). Put every dimension, size and "
    "capacity in specs as its own row (['Dimensions', '12 x 9 x 4 in'], ['Roll size', '500 mm x 23 "
    "mic']), never only inside the description: the app shows specs as a table. Double-check every "
    "product's photo: if the page shows a picture of it (including lazy-loaded data-src / srcset "
